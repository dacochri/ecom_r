...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { image: @slider.image, link: @slider.link, text: @slider.text, title: @slider.title }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { image: @slider.image, link: @slider.link, text: @slider.text, title: @slider.title }
    assert_redirected_to slider_path(assigns(:slider))
  end
